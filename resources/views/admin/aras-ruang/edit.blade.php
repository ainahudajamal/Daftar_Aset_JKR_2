...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm mb-4">
        ...
        <div id="collapseFormDA5" class="collapse show">
            <form action="{{ route('admin.aras-ruang.update', $record->id) }}" method="POST" id="formDA5">
                @csrf
                @method('PUT')
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-0">
                <iframe
                    src="{{ route('admin.aras-ruang.export-pdf', $record->id) }}"
                    width="100%"
                    height="650px"
                    style="border: none;">
                </iframe>
            ...
            <div class="modal-footer">
                <a href="{{ route('admin.aras-ruang.export-pdf', $record->id) }}" class="btn btn-success">
