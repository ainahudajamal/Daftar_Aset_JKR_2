...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <!-- Header -->
            <div class="mb-4">
                <h2 class="mb-1"><i class="bi bi-pencil"></i> Edit Aras</h2>
            ...
            <form action="{{ route('admin.aras.update', $aras) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <select name="blok_id" class="form-select @error('blok_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $blok->id }}" {{ old('blok_id', $aras->blok_id) == $blok->id ? 'selected' : '' }}>
                                        {{ $blok->kod }} - {{ $blok->nama }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kod" class="form-control @error('kod') is-invalid @enderror"
                                       value="{{ old('kod', $aras->kod) }}" required placeholder="Contoh: 01">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active"
                                           {{ old('is_active', $aras->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                                       value="{{ old('nama', $aras->nama) }}" required placeholder="Contoh: Aras 1">
                                @error('nama')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="d-flex gap-2 mb-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> Kemaskini Aras
                    </button>
