...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <form action="{{ route('admin.blok.update', $premis->id) }}" method="POST" id="mainForm">
                @csrf
                @method('PUT')
                ...
                <div class="card border-0 shadow-sm mb-3">
                    ...
                    <div id="seksyenBlok" class="{{ $premis->blok->count() > 0 ? '' : 'd-none' }}">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle mb-2" id="tableBlok">
                                    ...
                                    <tbody id="bodyBlok">
                                        ...
                                        <tr>
                                            <td class="text-center fw-semibold bil-blok">{{ $index + 1 }}</td>
                                            <td><input type="text" name="blok[{{ $index }}][nama_blok]" class="form-control form-control-sm" value="{{ $blok->nama_blok }}"></td>
                                            <td><input type="text" name="blok[{{ $index }}][fungsi_binaan]" class="form-control form-control-sm" value="{{ $blok->fungsi_binaan }}"></td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="number" name="blok[{{ $index }}][luas_tapak]" class="form-control form-control-sm" step="0.01" min="0" value="{{ $blok->luas_tapak }}">
                                                    <span class="input-group-text">m²</span>
                                                </div>
                                            </td>
                                            <td><input type="text" name="blok[{{ $index }}][kod_blok_myspata]" class="form-control form-control-sm" value="{{ $blok->kod_blok_myspata }}"></td>
                                            <td><input type="text" name="blok[{{ $index }}][catatan]" class="form-control form-control-sm" value="{{ $blok->catatan }}"></td>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header py-2 text-white" style="background-color: #4a5568 !important;">
                        <div class="form-check d-flex align-items-center gap-2 mb-0">
                            <input class="form-check-input mt-0 flex-shrink-0" type="checkbox"
                                ...
                                {{ $premis->binaanLuar->count() > 0 ? 'checked' : '' }}
                                style="width:1.2rem;height:1.2rem;">
                            <label class="form-check-label fw-semibold mb-0 text-white d-flex align-items-center gap-2"
                    ...
                    <div id="seksyenBinaan" class="{{ $premis->binaanLuar->count() > 0 ? '' : 'd-none' }}">
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle mb-2" id="tableBinaan">
                                    ...
                                    <tbody id="bodyBinaan">
                                        ...
                                        <tr>
                                            <td class="text-center fw-semibold bil-binaan">{{ $index + 1 }}</td>
                                            <td><input type="text" name="binaan_luar[{{ $index }}][nama_binaan_luar]" class="form-control form-control-sm" value="{{ $binaan->nama_binaan_luar }}"></td>
                                            <td><input type="text" name="binaan_luar[{{ $index }}][jenis_binaan_luar]" class="form-control form-control-sm" value="{{ $binaan->jenis_binaan_luar }}"></td>
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <input type="number" name="binaan_luar[{{ $index }}][luas_tapak]" class="form-control form-control-sm" step="0.01" min="0" value="{{ $binaan->luas_tapak }}">
                                                    <span class="input-group-text">m²</span>
                                                </div>
                                            </td>
                                            <td><input type="text" name="binaan_luar[{{ $index }}][kod_binaan_luar_myspata]" class="form-control form-control-sm" value="{{ $binaan->kod_binaan_luar_myspata }}"></td>
                                            <td><input type="text" name="binaan_luar[{{ $index }}][catatan]" class="form-control form-control-sm" value="{{ $binaan->catatan }}"></td>
                                            <td class="text-center">
