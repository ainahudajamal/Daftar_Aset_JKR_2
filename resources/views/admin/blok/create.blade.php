        ...
        <div class="col-md-10">
            ...
            <form action="{{ route('admin.blok.store') }}" method="POST" id="mainForm">
                        ...
                        <div class="row g-3">
                            <div class="col-md-7">
                                ...
                                <input type="text" name="nama_premis"
                                       ...
                                       value="{{ old('nama_premis') }}" required
                                       >
                                @error('nama_premis')
                            ...
                            <div class="col-md-5">
                                <label class="form-label fw-semibold">
                                    Nombor DPA <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="no_dpa"
                                       class="form-control @error('no_dpa') is-invalid @enderror"
                                       value="{{ old('no_dpa') }}" required
                                       >
                                @error('no_dpa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                ...
                <div class="card border-0 shadow-sm mb-3">
                    ...
                    <div id="seksyenBlok" class="{{ old('ada_blok') ? '' : 'd-none' }}">
                        <div class="card-body">
                                    ...
                                    <tbody id="bodyBlok">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button"
                                                        class="btn btn-danger btn-sm btn-padam-blok"
                                                        title="Padam baris">
                            ...
                            <div class="mt-2">
                                ...
                                <textarea name="catatan_blok" rows="2" class="form-control"
                                          >{{ old('catatan_blok') }}</textarea>
                            </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div id="seksyenBinaan" class="{{ old('ada_binaan_luar') ? '' : 'd-none' }}">
                        <div class="card-body">
                                ...
                                <table class="table table-bordered align-middle mb-2" id="tableBinaan">
                                    ...
                                    <tbody id="bodyBinaan">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button"
                                                        class="btn btn-danger btn-sm btn-padam-binaan"
                                                        title="Padam baris">
                                                    <i class="bi bi-x-lg"></i>
                                                </button>
                                            </td>
                            ...
                            <div class="mt-2">
                                <label class="form-label fw-semibold">Perihal / Catatan</label>
                                <textarea name="catatan_binaan" rows="2" class="form-control"
                                          >{{ old('catatan_binaan') }}</textarea>
                            </div>
                ...
                <div class="d-flex gap-2 mb-5">
                    <button type="submit" class="btn btn-primary px-4">
                        <i class="bi bi-floppy"></i> Simpan Komponen
                    </button>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renameIndexes(tbody, prefix) {
        tbody.querySelectorAll('tr').forEach(function (tr, i) {
            tr.querySelectorAll('input, textarea, select').forEach(function (el) {
                // tukar name="prefix[lama][field]" → "prefix[i][field]"
    ...
    document.getElementById('btnTambahBlok').addEventListener('click', function () {
        ...
        tr.innerHTML = `
            ...
            <td><input type="text" name="blok[${idx}][nama]"
                       class="form-control form-control-sm"
                       ></td>
            <td><input type="text" name="blok[${idx}][fungsi_binaan]"
                       class="form-control form-control-sm"
                       ></td>
            <td>
                <div class="input-group input-group-sm">
            ...
            <td><input type="text" name="blok[${idx}][kod_myspata]"
                       class="form-control form-control-sm"
                       ></td>
            <td class="text-center">
    ...
    document.getElementById('btnTambahBinaan').addEventListener('click', function () {
        ...
        tr.innerHTML = `
            ...
            <td><input type="text" name="binaan[${idx}][nama]"
                       class="form-control form-control-sm"
                       ></td>
            <td><input type="text" name="binaan[${idx}][jenis]"
                       class="form-control form-control-sm"
                       ></td>
            <td>
                <div class="input-group input-group-sm">
            ...
            <td><input type="text" name="binaan[${idx}][kod_myspata]"
                       class="form-control form-control-sm"
                       ></td>
            <td class="text-center">
