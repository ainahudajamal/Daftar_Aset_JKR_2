...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <!-- Header -->
            <div class="mb-4">
                <h2 class="mb-1"><i class="bi bi-pencil"></i> Edit Ruang</h2>
            ...
            <form action="{{ route('admin.ruang.update', $ruang) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <select name="aras_id" class="form-select @error('aras_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $item->id }}" {{ old('aras_id', $ruang->aras_id) == $item->id ? 'selected' : '' }}>
                                        {{ $item->kod }} - {{ $item->nama }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="kod" class="form-control @error('kod') is-invalid @enderror"
                                       value="{{ old('kod', $ruang->kod) }}" required placeholder="Contoh: R01">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"
                                       value="{{ old('nama', $ruang->nama) }}" required placeholder="Contoh: Bilik Mesyuarat">
                                @error('nama')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="d-flex gap-2 mb-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> Kemaskini Ruang
                    </button>
